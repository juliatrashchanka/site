...
function Company() {
  ...
  <div className='company'> 
    ...
    <div className={style.company_inf}>
      ...
      <img className={style.inf_img} src={  "https://www.prereal.com/uploads/load-imagetools.jpeg"}></img>
      ...
      <div className={style.inf_text_box}>
        ...
        <div className={style.inf_text}>
          ...
          <p>В перечень выполняемых работ входит весь комплекс строительных работ. </p>
          </div>
      </div>
